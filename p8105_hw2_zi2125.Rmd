...
The data is not tidy yet since each route is its own variable and some are listed as character variable while others are double vector variables. We need to convert them all to character and then merge into one variable to make it easier to work with. 
